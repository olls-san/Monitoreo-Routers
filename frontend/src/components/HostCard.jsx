...
export default function HostCard({
  ...
  return (
    <div
      onClick={onSelect}
      className={`rounded-2xl border cursor-pointer transition p-4 bg-gray-900 h-full flex flex-col ${
        selected
    ...
    >
      ...
      {/* BODY */}
      <div className="mt-4 grid grid-cols-2 gap-3 text-sm flex-1">
        ...
        <div className="rounded-xl border border-gray-800 bg-gray-950 p-3">
          ...
          <div className="text-gray-200 mt-1 truncate" title={lastAction}>
            {lastAction}
          </div>
        </div>
      </div>
      ...
      <div className="mt-auto pt-4">
        <div className="grid grid-cols-3 gap-3">
          <button
            ...
            className="h-11 rounded-xl bg-gray-800 hover:bg-gray-700 text-sm"
          >
            Comandos
          </button>
          ...
          <button
            ...
            className="h-11 rounded-xl bg-gray-950 border border-gray-800 hover:border-gray-700 text-sm"
          >
            Automatizaciones
          </button>
